...
sudo forever -l "/home/honey/logs/${new_scenario}/${date}_${new_name}.log" --id $new_name --append start /home/honey/MITM/mitm.js -n $new_name -i $new_container_ip -p $port --mitm-ip 127.0.0.1 --auto-access --auto-access-fixed 3 --debug
